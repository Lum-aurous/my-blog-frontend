...
<template>
    <div class="article-item-flat" @click="$emit('click')">
        ...
        <div class="article-thumb-v2">
            <div v-if="data.work_type === 'video' && data.video_url" class="media-container video-mode" @click.stop>
            ...
            <div v-else-if="data.work_type === 'audio'" class="media-container audio-mode">
                <div class="vinyl-record">
                    <img :src="getFullImageUrl(data.cover_image)" class="vinyl-cover" alt="album">
            ...
            <div v-else-if="data.cover_image" class="image-cover-wrapper">
                ...
                <div v-if="data.work_type === 'travel' || data.category === '游记'" class="geo-badge">
                    📍 {{ data.location || '未知秘境' }}
                </div>

                <div v-else-if="data.work_type === 'short'" class="type-badge short">📸</div>
            </div>
...
.article-item-flat:hover .item-media {
